...
// 		// wg *sync.WaitGroup,
// 		fmt.Println("in for loop", lgm)
// 		go func(lgm *game.Ply) {
// 			asyncSearch(lgm, &wg, &sem, minDepth, maxDepth, 0, pos.Turn.Other(), newPos, ev, alpha, beta)
// 		}(lgm)
// 		// go asyncSearch(legalMoves[num+1], &wg, &sem, num, minDepth, maxDepth, 0, pos.Turn.Other(), newPos, ev, alpha, beta)
// 	}
// 	// &wg,
...
// func asyncSearch(prevMove *game.Ply, wg *sync.WaitGroup, sem *chan evaluation, depth, maxDepth, depthCount uint, side game.Color, pos *game.Position, evaluator *Evaluator, alpha, beta float32) {
// 	// fmt.Println("in func")
